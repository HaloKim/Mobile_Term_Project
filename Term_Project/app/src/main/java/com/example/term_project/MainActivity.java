...
public class MainActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private static int CAMERA_FACING = Camera.CameraInfo.CAMERA_FACING_BACK; // Camera.CameraInfo.CAMERA_FACING_FRONT
    ...
    ImageView sample;
    //카메라 전후면 상태
    public static boolean mCameraFacing = true;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 전후면 카메라 전환 버튼
        ImageButton change = findViewById(R.id.cameraChange);
        ...
        filterBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                intent.putExtra("fromOnline", 0);
                startActivity(intent);
            }
        });
        ImageButton onlineBt = findViewById(R.id.button_online);
        onlineBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
